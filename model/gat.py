...
class GATConvE(MessagePassing):
    ...
    def forward(self, x, edge_index, edge_type, node_type, node_feature_extra, return_attention_weights=False):
        ...
        # print("x size:", x.size()) # [8000, 200]
        # print("edge_index size:", edge_index.size()) # [2, 60890]
        # print("edge_type size:", edge_type.size()) # [60890]
        # print("node_type size:", node_type.size()) # [8000]
